...
private static String prepareText(String s, boolean chgJoT)
{
s=s.toUppereCase().replaceAll("[^A-Z]","");
return chgJtoI? s.replace("J","I"):s.replace("Q","");
}
private static void main createTbl(String key,boolean chgJtoI)
{
charTable = new char[5][5];
positions= new Point[26];
String s=prepareText(key +"ABCDEFGJHIJKLMOPQRSTUVWXYZ",chgJtoI);
int len=s.length();
...
System.out.println("Simulating Playfair\n");
Sysytem.out.println("Input Message:"+txt);
